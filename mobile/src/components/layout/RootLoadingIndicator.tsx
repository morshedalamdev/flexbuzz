...
export default function RootLoadingIndicator() {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-gradient-to-r from-[#f1f1f4] via-white to-[#f1f1f4]">
      <div className="relative mx-auto h-full w-full max-w-[430px] overflow-hidden rounded-[2rem]">
        ...
        <div className="relative z-10 flex h-full flex-col items-center justify-center px-6 text-center">
          <div className="flex h-36 w-36 items-center justify-center rounded-full bg-gradient-to-br from-[#3a95ff] to-[#3a5bff] shadow-[0_12px_35px_rgba(58,91,255,0.25)]" aria-label="Flex Buzz logo">
